         ...
         >
            {isModerator && (
               <DropdownMenuItem
                  ...
                  className="text-indigo-600 dark:text-indigo-400 px-3 py-2 flex items-center cursor-pointer"
               >
                  Invite People
            ...
            {isAdmin && (
               <DropdownMenuItem className="px-3 py-2 flex items-center cursor-pointer">
                  Manage Members
            ...
            {isAdmin && (
               <DropdownMenuItem className="text-rose-500 px-3 py-3 flex items-center cursor-pointer">
                  Delete Server
